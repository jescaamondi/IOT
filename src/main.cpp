...
String page() {
  return "<!DOCTYPE html>"
         ...
         ".card { background: #1e1e1e; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.5); border-left: 5px solid #6f2c65; }"
         ...
         "button:hover { background-color: #778ba1; }"
         ...
         "</head>"
         "<body>"
         "<h1 style='text-align:center; color:#00ffff; margin-bottom:10px;'>ESP32 Dashboard</h1>"
         "<div class='container'>"
         "<div class='card'>"
         "<h2>Clock and Stopwatch</h2>"
